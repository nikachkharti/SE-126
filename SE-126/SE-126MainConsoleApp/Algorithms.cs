namespace SE_126MainConsoleApp
{
    public static class Algorithms
    {
        ...
        //დაწერეთ მეთოდი FindIndex რომელიც გადაცემულ რიცხვების მასივში მოძებნის რომელ ინდექსზე ინახება
        //კონკრეტული ელემენტი და დააბრუნებს ამ ინდექსს.

        //დაწერეთ ფუნქცია რომელიც ფაილში მოძებნის ბოლო ლამბორჯინის მარკის ავტომობილს
    }
}
